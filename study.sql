...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "HR"."SEQ_BOARD_NUM"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 50 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "HR"."MEMBER" 
   (	"USER_ID" VARCHAR2(18 BYTE), 
	...
	"USER_HODDY" VARCHAR2(50 BYTE), 
	"USER_JOB" VARCHAR2(50 BYTE), 
	"USER_INFO" VARCHAR2(2000 BYTE), 
	"MEGISTER_DATE" DATE DEFAULT sysdate, 
	"MEMBERLEVEL" VARCHAR2(5 BYTE)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
SET DEFINE OFF;
Insert into HR.MEMBER (USER_ID,USER_PW,USER_NAME,USER_EMAIL,USER_PHONE,USER_HODDY,USER_JOB,USER_INFO,MEGISTER_DATE,MEMBERLEVEL) values ('rudwlsWkd','1234','박경진','rudwls@naver.com','010-1234-1234','영화','변호사','22',to_date('22/06/24','RR/MM/DD'),'user');
Insert into HR.MEMBER (USER_ID,USER_PW,USER_NAME,USER_EMAIL,USER_PHONE,USER_HODDY,USER_JOB,USER_INFO,MEGISTER_DATE,MEMBERLEVEL) values ('taeksu','1234','택수','tmddyd804@naver.com','010-2405-4173','캠핑, 등산','교사','ddd',to_date('22/06/26','RR/MM/DD'),'user');
Insert into HR.MEMBER (USER_ID,USER_PW,USER_NAME,USER_EMAIL,USER_PHONE,USER_HODDY,USER_JOB,USER_INFO,MEGISTER_DATE,MEMBERLEVEL) values ('admin','admin','관리자','admin@admin.com','010-1111-1111','캠핑, 영화','변호사','안녕하세요 ㅇㅁㅇ/',to_date('22/06/22','RR/MM/DD'),'admin');
REM INSERTING into HR.MEMBER3
SET DEFINE OFF;
Insert into HR.MEMBER3 (USER_ID,USER_PW,USER_NAME,USER_EMAIL,USER_PHONE,MEGISTER_DATE,MEMBERLEVEL) values ('taeksu','1234','유택수','tmddyd804@naver.com','010-2405-4173',to_date('22/06/27','RR/MM/DD'),'HR');
Insert into HR.MEMBER3 (USER_ID,USER_PW,USER_NAME,USER_EMAIL,USER_PHONE,MEGISTER_DATE,MEMBERLEVEL) values ('admina','1234','유택수','tmddyd804@naver.com','010-2222-2222',to_date('22/06/29','RR/MM/DD'),'HR');
Insert into HR.MEMBER3 (USER_ID,USER_PW,USER_NAME,USER_EMAIL,USER_PHONE,MEGISTER_DATE,MEMBERLEVEL) values ('승헌','1234','승헌','tmdgjs@naver.com','010-2405-4173',to_date('22/06/28','RR/MM/DD'),'HR');
Insert into HR.MEMBER3 (USER_ID,USER_PW,USER_NAME,USER_EMAIL,USER_PHONE,MEGISTER_DATE,MEMBERLEVEL) values ('admin','admin','관리자','admin@admin.com','010-1111-1111',to_date('22/06/27','RR/MM/DD'),'admin');
Insert into HR.MEMBER3 (USER_ID,USER_PW,USER_NAME,USER_EMAIL,USER_PHONE,MEGISTER_DATE,MEMBERLEVEL) values ('admin14','1234','코스모','tmddyd804@naver.com','010-2405-4173',to_date('22/06/29','RR/MM/DD'),'HR');
REM INSERTING into HR.MVCBOARD
SET DEFINE OFF;
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (6,'ㅇㅇㄴ','ㅇㅇ','ㅇㅇ',to_date('22/06/27','RR/MM/DD'),null,null,0,'1234',7);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (7,'ㅇㅇ','ㅇㅇㅇ','ㅇㅇㅇ',to_date('22/06/27','RR/MM/DD'),null,null,0,'ㅇㅇㅇ',4);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (8,'택수','탁수','탁수',to_date('22/06/27','RR/MM/DD'),null,null,0,'1234',3);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (9,'이원재','스펀지밥','스펀지',to_date('22/06/27','RR/MM/DD'),'4.png','20220627_18313472.png',1,'1234',25);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (46,'2321','dd','dd',to_date('22/06/28','RR/MM/DD'),null,null,0,'123',1);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (47,'이정우','ㅇㅇ','ㅇㅇ',to_date('22/06/28','RR/MM/DD'),'apple.png','20220628_204739143.png',1,'1234',8);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (1,'김유신','자료실 제목1 입니다.','내용',to_date('22/06/27','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (2,'장보고','자료실 제목2 입니다.','내용',to_date('22/06/27','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (3,'이순신','자료실 제목3 입니다.','내용',to_date('22/06/27','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (4,'강감찬','자료실 제목4 입니다.','내용',to_date('22/06/27','RR/MM/DD'),null,null,0,'1234',3);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (5,'대조영','자료실 제목5 입니다.','내용',to_date('22/06/27','RR/MM/DD'),null,null,0,'1234',3);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (10,'장보고','자료실 제목2 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (11,'이순신','자료실 제목3 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (12,'강감찬','자료실 제목4 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (13,'대조영','자료실 제목5 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (14,'장보고','자료실 제목2 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (15,'이순신','자료실 제목3 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (16,'강감찬','자료실 제목4 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (17,'대조영','자료실 제목5 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (18,'장보고','자료실 제목2 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (19,'이순신','자료실 제목3 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (20,'강감찬','자료실 제목4 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (21,'대조영','자료실 제목5 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (22,'장보고','자료실 제목2 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (23,'이순신','자료실 제목3 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (24,'강감찬','자료실 제목4 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (25,'대조영','자료실 제목5 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (26,'장보고','자료실 제목2 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (27,'이순신','자료실 제목3 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (28,'강감찬','자료실 제목4 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (29,'대조영','자료실 제목5 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (30,'장보고','자료실 제목2 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (31,'이순신','자료실 제목3 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (32,'강감찬','자료실 제목4 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (33,'대조영','자료실 제목5 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (34,'장보고','자료실 제목2 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (35,'이순신','자료실 제목3 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (36,'강감찬','자료실 제목4 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (37,'대조영','자료실 제목5 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (38,'장보고','자료실 제목2 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',1);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (39,'이순신','자료실 제목3 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',1);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (40,'강감찬','자료실 제목4 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (41,'대조영','자료실 제목5 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (42,'장보고','자료실 제목2 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (43,'이순신','자료실 제목3 입니다.','내용',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',0);
Insert into HR.MVCBOARD (IDX,NAME,TITLE,CONTENT,POSTDATE,OFILE,SFILE,DOWNCOUNT,PASS,VISITCOUNT) values (44,'강감찬','자료실 제목4 입니다.','내용1234441221212123213123213123',to_date('22/06/28','RR/MM/DD'),null,null,0,'1234',18);
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."MEMBER" ADD PRIMARY KEY ("USER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."MEMBER" MODIFY ("MEGISTER_DATE" NOT NULL ENABLE);
  ALTER TABLE "HR"."MEMBER" MODIFY ("USER_JOB" NOT NULL ENABLE);
  ALTER TABLE "HR"."MEMBER" MODIFY ("USER_HODDY" NOT NULL ENABLE);
  ALTER TABLE "HR"."MEMBER" MODIFY ("USER_PHONE" NOT NULL ENABLE);
  ALTER TABLE "HR"."MEMBER" MODIFY ("USER_EMAIL" NOT NULL ENABLE);
  ALTER TABLE "HR"."MEMBER" MODIFY ("USER_NAME" NOT NULL ENABLE);
  ALTER TABLE "HR"."MEMBER" MODIFY ("USER_PW" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."MEMBER3" ADD PRIMARY KEY ("USER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."MEMBER3" MODIFY ("MEGISTER_DATE" NOT NULL ENABLE);
  ALTER TABLE "HR"."MEMBER3" MODIFY ("USER_PHONE" NOT NULL ENABLE);
  ALTER TABLE "HR"."MEMBER3" MODIFY ("USER_EMAIL" NOT NULL ENABLE);
  ALTER TABLE "HR"."MEMBER3" MODIFY ("USER_NAME" NOT NULL ENABLE);
  ALTER TABLE "HR"."MEMBER3" MODIFY ("USER_PW" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."MVCBOARD" ADD PRIMARY KEY ("IDX")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."MVCBOARD" MODIFY ("VISITCOUNT" NOT NULL ENABLE);
  ALTER TABLE "HR"."MVCBOARD" MODIFY ("PASS" NOT NULL ENABLE);
  ALTER TABLE "HR"."MVCBOARD" MODIFY ("DOWNCOUNT" NOT NULL ENABLE);
  ALTER TABLE "HR"."MVCBOARD" MODIFY ("POSTDATE" NOT NULL ENABLE);
  ALTER TABLE "HR"."MVCBOARD" MODIFY ("CONTENT" NOT NULL ENABLE);
  ALTER TABLE "HR"."MVCBOARD" MODIFY ("TITLE" NOT NULL ENABLE);
  ALTER TABLE "HR"."MVCBOARD" MODIFY ("NAME" NOT NULL ENABLE);
--------------------------------------------------------
